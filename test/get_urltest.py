...
play_source = dict(
    ...
    gather_facts='no',
    tasks=[
        dict(action=dict(module='get_url', args=dict(dest='/ngbss/adp/get_url_docker/Makefile', force='yes',
                                                     url='http://10.124.0.19/svn/CBSS4G/branches/branch_160607/BSS4.2/billing_X86/credit/src/Makefile',
                                                     url_username='Oreader', url_password='Oreader')))
    ]
)
